...
export type MutationKeySpecifier = ('addProject' | 'addServer' | 'approveMigration' | 'bind' | 'deleteProject' | 'deleteServer' | 'login' | 'logout' | 'migrate' | 'register' | 'resetApi' | 'resetPassword' | 'selectServer' | 'updateProject' | 'updateProjectEpisode' | 'updateServer' | 'updateServerOwners' | MutationKeySpecifier)[];
...
export type NotificationKeySpecifier = ('created' | 'data' | 'id' | 'read' | 'target' | NotificationKeySpecifier)[];
...
export type NotificationDataAdminBroadcastGQLKeySpecifier = ('link' | 'message' | NotificationDataAdminBroadcastGQLKeySpecifier)[];
export type NotificationDataAdminBroadcastGQLFieldPolicy = {
	link?: FieldPolicy<any> | FieldReadFunction<any>,
	message?: FieldPolicy<any> | FieldReadFunction<any>
};
export type PageInfoKeySpecifier = ('hasNextPage' | 'nextCursor' | 'perPage' | 'totalResults' | PageInfoKeySpecifier)[];
...
export type PartialProjectKeySpecifier = ('aliases' | 'assignments' | 'createdAt' | 'external' | 'id' | 'integrations' | 'poster' | 'serverId' | 'statuses' | 'title' | 'type' | 'updatedAt' | PartialProjectKeySpecifier)[];
...
export type PartialProjectInterfaceKeySpecifier = ('aliases' | 'assignments' | 'createdAt' | 'id' | 'integrations' | 'poster' | 'serverId' | 'statuses' | 'title' | 'type' | 'updatedAt' | PartialProjectInterfaceKeySpecifier)[];
...
export type PartialServerKeySpecifier = ('avatar' | 'id' | 'integrations' | 'name' | PartialServerKeySpecifier)[];
...
export type PartialServerInterfaceKeySpecifier = ('avatar' | 'id' | 'integrations' | 'name' | PartialServerInterfaceKeySpecifier)[];
...
export type ProjectKeySpecifier = ('aliases' | 'assignments' | 'collaborations' | 'createdAt' | 'external' | 'id' | 'integrations' | 'poster' | 'prediction' | 'serverId' | 'statuses' | 'title' | 'type' | 'updatedAt' | ProjectKeySpecifier)[];
...
export type ProjectAssigneeInfoKeySpecifier = ('id' | 'integrations' | 'name' | ProjectAssigneeInfoKeySpecifier)[];
export type ProjectAssigneeInfoFieldPolicy = {
	id?: FieldPolicy<any> | FieldReadFunction<any>,
	integrations?: FieldPolicy<any> | FieldReadFunction<any>,
	name?: FieldPolicy<any> | FieldReadFunction<any>
};
export type ProjectCollabConfirmationKeySpecifier = ('code' | 'id' | 'source' | 'target' | ProjectCollabConfirmationKeySpecifier)[];
...
export type ProjectCollabConfirmationInfoKeySpecifier = ('project' | 'server' | ProjectCollabConfirmationInfoKeySpecifier)[];
export type ProjectCollabConfirmationInfoFieldPolicy = {
	project?: FieldPolicy<any> | FieldReadFunction<any>,
	server?: FieldPolicy<any> | FieldReadFunction<any>
};
export type ProjectCollabLinkKeySpecifier = ('id' | 'project' | 'projects' | 'servers' | ProjectCollabLinkKeySpecifier)[];
...
export type ProjectConnectionKeySpecifier = ('_total' | 'nodes' | 'pageInfo' | ProjectConnectionKeySpecifier)[];
export type ProjectConnectionFieldPolicy = {
	_total?: FieldPolicy<any> | FieldReadFunction<any>,
	nodes?: FieldPolicy<any> | FieldReadFunction<any>,
	pageInfo?: FieldPolicy<any> | FieldReadFunction<any>
};
export type ProjectEpisodeUpdateSubsKeySpecifier = ('new' | 'old' | 'project' | 'projectId' | 'server' | 'serverId' | 'timestamp' | ProjectEpisodeUpdateSubsKeySpecifier)[];
...
export type ProjectExternalAniListKeySpecifier = ('episodes' | 'id' | 'malId' | 'startTime' | 'type' | ProjectExternalAniListKeySpecifier)[];
...
export type ProjectExternalEpisodeKeySpecifier = ('airtime' | 'episode' | 'season' | 'title' | ProjectExternalEpisodeKeySpecifier)[];
...
export type ProjectExternalTMDbKeySpecifier = ('episodes' | 'id' | 'startTime' | 'type' | ProjectExternalTMDbKeySpecifier)[];
...
export type ProjectStatusKeySpecifier = ('airingAt' | 'delayReason' | 'episode' | 'isReleased' | 'roles' | ProjectStatusKeySpecifier)[];
...
export type QueryKeySpecifier = ('latests' | 'project' | 'projects' | 'search' | 'server' | 'servers' | 'session' | 'stats' | 'user' | QueryKeySpecifier)[];
...
export type SearchResultKeySpecifier = ('count' | 'coverUrl' | 'format' | 'id' | 'season' | 'source' | 'title' | 'titles' | 'year' | SearchResultKeySpecifier)[];
...
export type SearchResultTitleKeySpecifier = ('english' | 'native' | 'romanized' | SearchResultTitleKeySpecifier)[];
...
export type ServerKeySpecifier = ('avatar' | 'id' | 'integrations' | 'name' | 'owners' | 'projects' | ServerKeySpecifier)[];
...
export type SubscriptionKeySpecifier = ('notification' | 'projectDeletion' | 'projectEpisodeUpdates' | 'serverDeletion' | SubscriptionKeySpecifier)[];
...
export type UserSessionKeySpecifier = ('active' | 'activeId' | 'id' | 'privilege' | 'token' | 'username' | UserSessionKeySpecifier)[];
...
export type UserTemporaryKeySpecifier = ('approvalCode' | 'id' | 'type' | 'username' | UserTemporaryKeySpecifier)[];
...
export type StrictTypedTypePolicies = {
	...
	IntKeyValueNodeResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | IntKeyValueNodeResultKeySpecifier | (() => undefined | IntKeyValueNodeResultKeySpecifier),
	...
	NotificationDataAdminBroadcastGQL?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | NotificationDataAdminBroadcastGQLKeySpecifier | (() => undefined | NotificationDataAdminBroadcastGQLKeySpecifier),
	...
	PartialProjectInterface?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PartialProjectInterfaceKeySpecifier | (() => undefined | PartialProjectInterfaceKeySpecifier),
	...
	PartialServerInterface?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PartialServerInterfaceKeySpecifier | (() => undefined | PartialServerInterfaceKeySpecifier),
	...
	ProjectAssigneeInfo?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ProjectAssigneeInfoKeySpecifier | (() => undefined | ProjectAssigneeInfoKeySpecifier),
		fields?: ProjectAssigneeInfoFieldPolicy,
	},
	ProjectCollabConfirmation?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ProjectCollabConfirmationKeySpecifier | (() => undefined | ProjectCollabConfirmationKeySpecifier),
		fields?: ProjectCollabConfirmationFieldPolicy,
	},
	ProjectCollabConfirmationInfo?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ProjectCollabConfirmationInfoKeySpecifier | (() => undefined | ProjectCollabConfirmationInfoKeySpecifier),
	...
	ProjectEpisodeUpdateSubs?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ProjectEpisodeUpdateSubsKeySpecifier | (() => undefined | ProjectEpisodeUpdateSubsKeySpecifier),
	...
	ProjectExternalAniList?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ProjectExternalAniListKeySpecifier | (() => undefined | ProjectExternalAniListKeySpecifier),
		fields?: ProjectExternalAniListFieldPolicy,
	},
	ProjectExternalEpisode?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ProjectExternalEpisodeKeySpecifier | (() => undefined | ProjectExternalEpisodeKeySpecifier),
		fields?: ProjectExternalEpisodeFieldPolicy,
	},
	ProjectExternalTMDb?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ProjectExternalTMDbKeySpecifier | (() => undefined | ProjectExternalTMDbKeySpecifier),
