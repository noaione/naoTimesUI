...
export type MutationKeySpecifier = ('addProject' | 'addServer' | 'approveMigration' | 'approveRegister' | 'deleteProject' | 'deleteServer' | 'login' | 'logout' | 'migrate' | 'register' | 'resetApi' | 'resetPassword' | 'selectServer' | 'updateProject' | 'updateProjectEpisode' | 'updateServer' | 'updateServerOwners' | MutationKeySpecifier)[];
export type MutationFieldPolicy = {
	...
	approveRegister?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type SubscriptionKeySpecifier = ('projectDeletion' | 'projectEpisodeUpdates' | 'serverDeletion' | SubscriptionKeySpecifier)[];
