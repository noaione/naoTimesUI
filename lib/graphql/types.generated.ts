...
export type Notification = {
  ...
  created: Scalars['UNIX']['output'];
  /** The data for the notification. */
  data?: Maybe<NotificationDataAdminBroadcastGqlProjectCollabConfirmation>;
...
/** The data for the notification for the admin broadcast. */
export type NotificationDataAdminBroadcastGql = {
  __typename?: 'NotificationDataAdminBroadcastGQL';
...
export type NotificationDataAdminBroadcastGqlProjectCollabConfirmation = NotificationDataAdminBroadcastGql | ProjectCollabConfirmation;
...
/** A confirmation link to a project collab. */
export type ProjectCollabConfirmation = {
  __typename?: 'ProjectCollabConfirmation';
  /** The code of this confirmation link. */
  code: Scalars['String']['output'];
  /** The ID of this confirmation. */
  id: Scalars['UUID']['output'];
  /** The source of this confirmation link. */
  source: ProjectCollabConfirmationInfo;
  /** The target of this confirmation link. */
  target: ProjectCollabConfirmationInfo;
};

/** A confirmation link information of each link to a project collab. */
export type ProjectCollabConfirmationInfo = {
  __typename?: 'ProjectCollabConfirmationInfo';
  /** The partial project information */
